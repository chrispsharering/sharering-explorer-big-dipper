    ...
    return <Card body>
        <SentryBoundary><Row className="validator-info">
            ...
            <Col className="voting-power data" xs={{size:8, offset:2}} md={{size:3, offset:0}} lg={2}>
                ...
                <span>{props.validator.voting_power?numbro(props.validator.voting_power).format('0,0'):0} ({props.validator.voting_power?numbro(props.validator.voting_power/props.totalPower).format('0.00%'):"0.00%"})</span>
            </Col>
            <Col className="self-delegation data" xs={{size:4,offset:2}} md={{size:1,offset:0}}>
                <i className="material-icons d-md-none">equalizer</i>
                <span>{props.validator.self_delegation?numbro(props.validator.self_delegation).format('0.00%'):'N/A'}</span>
            </Col>
            ...
            {(!props.inactive)?<Col className="uptime data" md={2}>
                                    <i className="material-icons d-md-none">flash_on</i>
                                    <span style={{ width: '95%' }}>
                                        <Progress animated value={props.validator.uptime}>
                                            <span className="d-block">{props.validator.uptime?props.validator.uptime.toFixed(2):0}%</span>
